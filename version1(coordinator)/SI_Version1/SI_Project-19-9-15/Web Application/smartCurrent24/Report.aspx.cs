...
namespace SmartIrrigation
{
    public partial class Report : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            protected void btng_s_m_Click(object sender, EventArgs e)
            {             
                Response.Redirect("Graph_1.aspx");
            }

            protected void btn_g_w_f_Click(object sender, EventArgs e)
            {
                Response.Redirect("Graph_2.aspx");
            }

        protected void btn_g_e_u_t_Click(object sender, EventArgs e)
            {                        
                Response.Redirect("Graph_3.aspx");
            }
