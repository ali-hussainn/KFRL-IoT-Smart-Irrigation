<%@ Page Title="SmartIrrigation" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="SmartIrrigation.AdminLogin" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <table class="style1">
        <tr>
            ...
            <td class="style5" rowspan="4">
                <asp:Image ID="Image1" runat="server" Height="284px" 
                    ImageUrl="~/images/admin.jpg" Width="382px" />
            </td>
        </tr>
        <tr>
            <td class="style3">
        ...
        <tr>
            ...
            <td class="style7">
                <asp:Button ID="btnLogin1" runat="server" CssClass="MediumButton" Text="Login" 
