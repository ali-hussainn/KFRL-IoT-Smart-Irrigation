...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    ...
    <p class="style3">
        <asp:GridView ID="grd_User_home" runat="server" Height="250px" Width="700px" 
            AutoGenerateColumns="False" CellSpacing="10" HorizontalAlign="Center">
            <Columns>
         <asp:BoundField DataField="Sensor_ID" HeaderText="Sensor_ID" 
        ...
        <p class="style3">
            <asp:Button ID="btn_g_r" runat="server" Text="Generate Report" 
                onclick="btn_g_r_Click" Width="200px" Height="30px" />
            </p>
        <p class="style3">
            <asp:ImageButton ID="img_btn_menu" runat="server" />
            <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="Button" Width="123px" />
            </p>
        <p class="style3">
            <asp:Button ID="btn_sensor" runat="server" OnClick="btn_sensor_Click" Text="Sensor Data View" Width="200px" Height="30px" />    
        </p>
        <p class="style3">
            <asp:Button ID="btn_valve" runat="server" onclick="btn_valve_Click" 
            Text="Valve Status" Width="200px" Height="30px" Visible="False" />
